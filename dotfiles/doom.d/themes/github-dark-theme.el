...
(autothemer-deftheme github-dark "A light theme inspired by GitHub's color scheme"
                     ...
                     (
                      ...
                      (fringe (:background github-dark-gray-llll))
                      (match (:background github-dark-yellow-ll))
                      (+workspace-tab-selected-face (:inherit 'match))
                      ...
                      (header-line (:background github-dark-bg :foreground github-dark-gray-l :bold nil
